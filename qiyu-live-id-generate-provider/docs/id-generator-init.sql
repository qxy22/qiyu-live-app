CREATE TABLE IF NOT EXISTS `t_id_generate_config` (
...
INSERT INTO `t_id_generate_config`
(`id`, `remark`, `init_num`, `step`, `is_seq`, `current_start`, `next_threshold`, `id_prefix`, `version`)
VALUES
(1, 'user id', 100000, 1000, 1, 100000, 101000, 'U', 0)
